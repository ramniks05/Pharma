...
function buildWhatsAppMessage(productName, data) {
  const lines = [
...
export default function EnquiryModal({ productName, productId, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    const text = buildWhatsAppMessage(productName, form)
      ...
      <div className="enquiry-modal" onClick={(e) => e.stopPropagation()}>
        <div className="enquiry-modal__header">
          <div className="enquiry-modal__header-content">
            ...
            <div>
              <h2 id="enquiry-title" className="enquiry-modal__title">Product Enquiry</h2>
              <p className="enquiry-modal__product">{productName}</p>
            </div>
          </div>
