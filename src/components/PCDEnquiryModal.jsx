...
function buildPCDWhatsAppMessage(data) {
  const lines = [
...
export default function PCDEnquiryModal({ onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    const text = buildPCDWhatsAppMessage(form)
      ...
      <div className="enquiry-modal" onClick={(e) => e.stopPropagation()}>
        <div className="enquiry-modal__header">
          <div className="enquiry-modal__header-content">
            ...
            <div>
              <h2 id="enquiry-title" className="enquiry-modal__title">Get PCD Distributorship</h2>
              <p className="enquiry-modal__product">Join BSR Pharma as a Franchise Partner</p>
            </div>
          </div>
        ...
        <div className="enquiry-modal__body">
          ...
          <form className="enquiry-form" onSubmit={handleSubmit}>
            ...
            <div className="enquiry-form__group">
              <label className="enquiry-form__label">
                <span className="enquiry-form__label-text">Email</span>
                <input
                  type="email"
                  name="email"
                  value={form.email}
            ...
            <div className="enquiry-form__group">
              <label className="enquiry-form__label">
                <span className="enquiry-form__label-text">City <span className="enquiry-form__required">*</span></span>
                <input
                  type="text"
                  name="city"
                  value={form.city}
            ...
            <div className="enquiry-form__group">
              <label className="enquiry-form__label">
                <span className="enquiry-form__label-text">Services / Business Type</span>
                <input
                  type="text"
                  name="services"
                  value={form.services}
                  onChange={handleChange}
                  className="enquiry-form__input"
                  placeholder="e.g., Pharmaceutical Distribution, Retail"
                />
              </label>
            </div>
            <div className="enquiry-form__group">
              <label className="enquiry-form__label">
                <span className="enquiry-form__label-text">Experience (Years)</span>
                <input
                  type="text"
                  name="experience"
            ...
            <div className="enquiry-form__group">
              <label className="enquiry-form__label">
                <span className="enquiry-form__label-text">Message</span>
                <textarea
                  name="message"
                  value={form.message}
                  onChange={handleChange}
            ...
            <div className="enquiry-form__group">
              <label className="enquiry-form__label">
                <span className="enquiry-form__label-text">
                  Captcha: {captchaValue.num1} + {captchaValue.num2} = ? <span className="enquiry-form__required">*</span>
                </span>
                <input
                  type="number"
                  value={captcha}
            ...
            <div className="enquiry-form__actions">
              <button type="button" className="enquiry-form__cancel" onClick={onClose}>
                Cancel
              </button>
